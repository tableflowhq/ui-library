...
var SvgCheck = function SvgCheck(props) {
  return /*#__PURE__*/React__namespace.createElement("svg", _extends$n({
    ...
    xmlSpace: "preserve",
    fill: "#98A2B3"
  }, props), _g$4 || (_g$4 = /*#__PURE__*/React__namespace.createElement("g", null, /*#__PURE__*/React__namespace.createElement("path", {
...
function Icon(_a) {
    ...
    return IconComponent ? jsxRuntime.jsx(IconComponent, __assign({}, props)) : null;
}
...
function usePassword() {
    ...
    return {
        ...
        iconAfter: (jsxRuntime.jsx("button", __assign({ type: "button", onClick: function () { return setShow(function (s) { return !s; }); }, tabIndex: 0 }, { children: jsxRuntime.jsx(Icon, { icon: show ? "eyesOpen" : "eyesClosed" }) }))),
...
function Box(_a) {
    ...
    return jsxRuntime.jsx("div", __assign({}, props, { className: containerClasses }));
}
...
function Frame(_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: style$e.container }, { children: jsxRuntime.jsx("div", __assign({ className: style$e.content }, { children: jsxRuntime.jsx(Box, { children: children }) })) })));
}
...
function Main(_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: style$d.container, "data-layout": "main" }, { children: jsxRuntime.jsx("div", __assign({ className: classes([style$d.content, center && style$d.center]) }, { children: children })) })));
}
...
function useSyncPagination(data, itemsPerPage) {
    ...
    var _a = React.useState(0), page = _a[0], setPageNumber = _a[1];
    var _b = React.useState(getDataPage(data, itemsPerPage, page)), dataPage = _b[0], setData = _b[1];
...
var useThemeStore = zustand.create()(middleware.persist(function (set) { return ({
    theme: "light" ,
...
function useTabs(tabs, initialValue) {
    ...
    var _b = React.useState(initialValue || (tabs === null || tabs === void 0 ? void 0 : tabs[(_a = Object.keys(tabs)) === null || _a === void 0 ? void 0 : _a[0]])), tab = _b[0], setTab = _b[1];
...
function useFilter(filterByColumns, data) {
    ...
    var dataFiltered = React.useMemo(function () {
...
function useSort(data, initialSortKey, initialSortAsc) {
    ...
    var _a = React.useState(initialSortKey), sortKey = _a[0], setSortKey = _a[1];
    var _b = React.useState(initialSortAsc), sortAsc = _b[0], setSortAsc = _b[1];
    var dataSorted = React.useMemo(function () {
...
function Badge(_a) {
    ...
    return jsxRuntime.jsx("span", __assign({}, props, { className: badgeClasses }));
}
...
function Button(_a) {
    ...
    var iconElement = (jsxRuntime.jsx("span", __assign({ className: style$b.icon }, { children: jsxRuntime.jsx(Icon, { icon: iconId }) })));
    return (jsxRuntime.jsxs("button", __assign({}, props, { className: containerClassName }, { children: [!!iconId && iconPosition === "left" && iconElement, children && jsxRuntime.jsx("span", __assign({ className: style$b.label }, { children: children })), !!iconId && iconPosition === "right" && iconElement] })));
}
...
var FocusLock$1 = /*#__PURE__*/React__namespace.forwardRef(function FocusLockUI(props, parentRef) {
  ...
  }), /*#__PURE__*/React__namespace.createElement(Container, _extends$2({
    ref: mergedRef
  }, lockProps, {
    className: className,
    onBlur: onBlur,
...
var FocusLockCombination = /*#__PURE__*/React__namespace.forwardRef(function FocusLockUICombination(props, ref) {
  return /*#__PURE__*/React__namespace.createElement(FocusLockUI, _extends$2({
    sideCar: FocusTrap,
    ref: ref
  }, props));
});
...
function Dialog(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ ref: ref, className: containerClasses }, { children: [jsxRuntime.jsx(Button, __assign({}, buttonProps, { type: "button", onClick: function () { return setOpen(!open); } }, { children: (useActiveAsLabel && ((_b = items.find(function (item) { return item.active; })) === null || _b === void 0 ? void 0 : _b.children)) || props.children })), open && (jsxRuntime.jsx(FocusLock, __assign({ className: style$a.items }, { children: items.map(function (item, i) {
                    item.id; var active = item.active; item.action; var props = __rest(item, ["id", "active", "action"]);
                    return !active || !useActiveAsLabel ? (React.createElement(Button, __assign({}, props, { variants: ["bare", "alignLeft"], type: "button", key: i, onClick: handleClick(item), className: classes([style$a.item, active && style$a.active]), iconPosition: "right" }), item.children)) : null;
                }) })))] })));
}
...
function Errors(_a) {
    var error = _a.error;
    return error ? (jsxRuntime.jsx("div", __assign({ className: style$9.errors }, { children: jsxRuntime.jsxs("p", { children: [jsxRuntime.jsx(Icon, { icon: "error" }), error.toString()] }) }))) : null;
}
...
function Input(_a) {
    ...
    var icon1 = icon && (jsxRuntime.jsx("span", __assign({ className: style$8.icon }, { children: jsxRuntime.jsx(Icon, { icon: icon }) })));
    var icon2 = iconAfter ? (jsxRuntime.jsx("span", __assign({ className: style$8.icon }, { children: typeof iconAfter === "string" ? jsxRuntime.jsx(Icon, { icon: iconAfter }) : iconAfter }))) : (error && (jsxRuntime.jsx("span", __assign({ className: style$8.icon }, { children: jsxRuntime.jsx(Icon, { icon: "error" }) }))));
    var iconSelect = options && (jsxRuntime.jsx("span", __assign({ className: classes([style$8.icon, style$8.dropdownIcon]) }, { children: jsxRuntime.jsx(Icon, { icon: "arrowHeadDown" }) })));
    var selectElement = options && options && jsxRuntime.jsx(Select, __assign({ options: options }, props));
    var inputWrapper = (jsxRuntime.jsxs("div", __assign({ className: classes([style$8.inputWrapper, error && style$8.hasError]) }, { children: [icon1, selectElement || jsxRuntime.jsx(Element, __assign({}, props, (options ? { type: "text" } : {}))), iconSelect, icon2] })));
    return (jsxRuntime.jsxs("div", __assign({ className: containerClassName }, { children: [label ? (jsxRuntime.jsxs("label", { children: [jsxRuntime.jsx("span", __assign({ className: style$8.label }, { children: label })), inputWrapper] })) : (inputWrapper), error && jsxRuntime.jsx("div", __assign({ className: style$8.error }, { children: error })), children && jsxRuntime.jsx("div", __assign({ className: style$8.footer }, { children: children }))] })));
}
function Select(_a) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("input", __assign({}, props, { value: selectedKey, className: style$8.select, readOnly: true })), jsxRuntime.jsx("div", __assign({ className: style$8.options }, { children: Object.keys(options).map(function (k) { return (jsxRuntime.jsx("button", __assign({ className: classes([style$8.option, options[k].value === props.value && style$8.selected]), type: "button" }, options[k], { onClick: onChangeOption }, { children: k }), k)); }) }))] }));
}
...
function Tableflow(_a) {
    ...
    return jsxRuntime.jsx("div", __assign({ className: className }, { children: color ? jsxRuntime.jsx(SvgTableflowLogoColor, {}) : jsxRuntime.jsx(SvgTableflowLogo, {}) }));
}

function Loader() {
    return (jsxRuntime.jsx("div", __assign({ className: style$7.container }, { children: jsxRuntime.jsx(Tableflow, { size: "big" }) })));
}
...
function Modal(_a) {
    ...
    var content = (jsxRuntime.jsx(FocusLock, { children: jsxRuntime.jsxs("div", __assign({}, props, { className: className }, { children: [jsxRuntime.jsx("div", { className: style$5.veil, onClick: function () { return handleClose && handleClose(); } }), jsxRuntime.jsxs(Element, __assign({ className: style$5.content }, { children: [useCloseButton && (jsxRuntime.jsx("button", __assign({ type: "button", onClick: handleClose, className: style$5.close }, { children: jsxRuntime.jsx(Icon, { icon: "cross" }) }))), children] }))] })) }));
    return usePortal ? jsxRuntime.jsxs(Portal, { children: [" ", content] }) : content;
}

var usePaginator = function (totalItems, itemsPerPage, initialPage, paginatorSize) {
    if (paginatorSize === void 0) { paginatorSize = 10; }
    var _a = React.useState(initialPage), currentPage = _a[0], setCurrentPage = _a[1];
...
function Pagination(_a) {
    ...
    var renderPageNumbers = pages.map(function (number) {
        ...
        return (jsxRuntime.jsx("button", __assign({ onClick: function () { return handleClick(number); }, disabled: currentPage === number, className: className }, { children: number }), number));
    });
    var arrowClass = classes([style$4.arrow]);
    return (jsxRuntime.jsx("div", __assign({ className: !hide ? style$4.paginator : "" }, { children: !hide && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [!hideArrows && showFirstLast && (jsxRuntime.jsx("button", __assign({ onClick: function () { return handleClick(firstPage || 0); }, disabled: firstPage === null, className: arrowClass }, { children: firstPage !== null && "".concat(firstPage, "...") }))), showArrows && (jsxRuntime.jsx("button", __assign({ onClick: function () { return handleClick(prevPage || 0); }, disabled: prevPage === null, className: arrowClass }, { children: jsxRuntime.jsx(Icon, { icon: "arrowLeft" }) }))), showNumbers && renderPageNumbers, showArrows && (jsxRuntime.jsx("button", __assign({ onClick: function () { return handleClick(nextPage || 0); }, disabled: nextPage === null, className: arrowClass }, { children: jsxRuntime.jsx(Icon, { icon: "arrowRight" }) }))), !hideArrows && showFirstLast && (jsxRuntime.jsx("button", __assign({ onClick: function () { return handleClick(lastPage || 0); }, disabled: lastPage === null, className: arrowClass }, { children: lastPage !== null && "...".concat(lastPage) })))] })) })));
}
...
function Stepper(_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: style$3.stepper }, { children: steps.map(function (step, i) {
            var done = i < current;
            ...
            var buttonProps = clickable
                ...
                : {};
            return (jsxRuntime.jsxs(Element, __assign({ className: classes([style$3.step, i === current ? style$3.active : done && style$3.done]) }, buttonProps, { children: [jsxRuntime.jsx("div", __assign({ className: style$3.badge }, { children: done ? jsxRuntime.jsx(Icon, { icon: "check" }) : i + 1 })), jsxRuntime.jsx("div", __assign({ className: style$3.label }, { children: step.label }))] }), i));
        }) })));
}
...
function Switch(_a) {
    ...
    var labelElement = jsxRuntime.jsx("span", __assign({ className: styles.label }, { children: label }));
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("label", __assign({ className: classes([styles.container, className]) }, { children: [!inputFirst && labelElement, jsxRuntime.jsx("input", __assign({ type: "checkbox" }, props)), jsxRuntime.jsx("span", { className: classes([styles.slider]) }), inputFirst && labelElement] })) }));
}
...
function Table(_a) {
    ...
    if (!data || !(data === null || data === void 0 ? void 0 : data.length))
        return jsxRuntime.jsx("div", __assign({ className: style.emptyMsg }, { children: emptyState || null }));
    var tableStyle = classes([style === null || style === void 0 ? void 0 : style.table, style === null || style === void 0 ? void 0 : style[background]]);
    var headingContent = heading ? (jsxRuntime.jsx("div", __assign({ className: style.caption }, { children: heading }))) : (jsxRuntime.jsx("div", __assign({ className: style.thead, role: "rowgroup" }, { children: jsxRuntime.jsx(Row, { datum: thead, isHeading: true }) })));
    return (jsxRuntime.jsxs(TableContext.Provider, __assign({ value: context }, { children: [jsxRuntime.jsxs("div", __assign({ className: tableStyle, role: "table" }, { children: [headingContent, jsxRuntime.jsx("div", __assign({ className: style.tbody, role: "rowgroup" }, { children: data.map(function (d, i) {
                            var key = keyAsId && (d === null || d === void 0 ? void 0 : d[keyAsId]) ? d[keyAsId] : i;
                            var props = { datum: d };
                            return React.createElement(Row, __assign({}, props, { key: key === null || key === void 0 ? void 0 : key.toString() }));
                        }) }))] })), !data.length && (jsxRuntime.jsx("div", __assign({ className: style.emptyMsg, role: "empty-query" }, { children: jsxRuntime.jsx("p", { children: "Empty" }) })))] })));
}
var Row = function (_a) {
    var datum = _a.datum;
    ...
    return (jsxRuntime.jsx("div", __assign({ className: className, role: "row" }, { children: Object.keys(datum)
            ...
            return (jsxRuntime.jsx(Cell, __assign({ cellClass: cellClass, cellStyle: cellStyle }, { children: wrappedContent }), k));
        }) })));
};
var Cell = function (_a) {
    ...
    return jsxRuntime.jsx("div", __assign({}, cellProps, { children: children }));
};
...
function Tabs(_a) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", __assign({ className: style$2.tabs }, { children: Object.keys(tabs).map(function (k) { return (jsxRuntime.jsx("button", __assign({ type: "button", className: classes([style$2.tabBtn, tabs[k] === tab && style$2.active]), onClick: function () {
                        if (setTab)
                            setTab(tabs[k]);
                        if (onChange)
                            onChange(tabs[k]);
                    }, disabled: tabs[k] === tab }, { children: k }), k)); }) })), children && jsxRuntime.jsx("div", __assign({ className: classes([style$2.tabContent, style$2.active]) }, { children: children }))] }));
}
...
function Tag(_a) {
    ...
    var _c = React.useState(false), selected = _c[0], setSelected = _c[1];
    var _d = React.useState(text), prevMemoText = _d[0], setPrevMemoText = _d[1];
    var memoText = React.useMemo(function () {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classes([style$1.tag, error && style$1.hasError]), tabIndex: 0, title: error, onFocus: setIsSelected, ref: ref }, { children: [selected ? (jsxRuntime.jsx("span", __assign({ contentEditable: true, autoFocus: true, onInput: onChange, className: style$1.input, suppressContentEditableWarning: true }, { children: memoText }))) : (memoText), error && jsxRuntime.jsx(Icon, { icon: "error" }), jsxRuntime.jsx("button", __assign({ type: "button", onClick: function () { return removeTag(id); } }, { children: jsxRuntime.jsx(Icon, { icon: "cross" }) }))] })));
}
...
function TagEditor(_a) {
    ...
    var _e = React.useState(""), input = _e[0], setInput = _e[1];
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", __assign({ className: classes([style$1.container, className]) }, props, { children: [jsxRuntime.jsx("div", { className: style$1.backDrop, onClick: function () { var _a; return (_a = ref === null || ref === void 0 ? void 0 : ref.current) === null || _a === void 0 ? void 0 : _a.focus(); } }), tags === null || tags === void 0 ? void 0 : tags.map(function (text, i) { return (jsxRuntime.jsx(Tag, __assign({}, { text: text, removeTag: removeTag, editTag: editTag, validation: validation, id: i }), text + i)); }), jsxRuntime.jsx("input", { placeholder: placeholder, onChange: onInputChange, value: input, ref: ref, onFocus: function (event) { return event.target.select(); }, onKeyDownCapture: handleKeyPress })] })), error && (jsxRuntime.jsxs("div", __assign({ className: style$1.error }, { children: [jsxRuntime.jsx(Icon, { icon: "error" }), " ", error] }))), jsxRuntime.jsx("div", { className: style$1.spacer })] }));
}
...
function ThemeToggle() {
    ...
    return (jsxRuntime.jsx("button", __assign({ className: style.themeToggle, onClick: function () { return setTheme(); } }, { children: jsxRuntime.jsxs("span", __assign({ className: style.inner }, { children: [jsxRuntime.jsx("span", { children: jsxRuntime.jsx(Icon, { icon: "sun" }) }), jsxRuntime.jsx("span", { children: jsxRuntime.jsx(Icon, { icon: "moon" }) })] })) })));
}
...
exports.useSyncPagination = useSyncPagination;
