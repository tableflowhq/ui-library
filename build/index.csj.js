...
import React__default, { useState, useEffect, PureComponent, useCallback, useRef, createElement, createContext, useContext, useMemo } from 'react';
...
function Button(_a) {
    ...
    var variantStyles = classes(variants.map(function (c) { return style$a[c]; }));
    var containerClassName = classes([style$a.button, variantStyles, className]);
    var iconId = ["sort", "sortUp", "sortDown"].some(function (i) { return variants.includes(i); }) ? "sort" : icon;
    var iconElement = (jsx("span", __assign({ className: style$a.icon }, { children: jsx(Icon, { icon: iconId }) })));
    return (jsxs("button", __assign({}, props, { className: containerClassName }, { children: [!!iconId && iconPosition === "left" && iconElement, children && jsx("span", __assign({ className: style$a.label }, { children: children })), !!iconId && iconPosition === "right" && iconElement] })));
}
...
function Input(_a) {
    ...
    var containerClassName = classes([style$7.container, variantStyles, className]);
    var icon1 = icon && (jsx("span", __assign({ className: style$7.icon }, { children: jsx(Icon, { icon: icon }) })));
    var icon2 = iconAfter ? (jsx("span", __assign({ className: style$7.icon }, { children: typeof iconAfter === "string" ? jsx(Icon, { icon: iconAfter }) : iconAfter }))) : (error && (jsx("span", __assign({ className: style$7.icon }, { children: jsx(Icon, { icon: "error" }) }))));
    var iconSelect = options && (jsx("span", __assign({ className: classes([style$7.icon, style$7.dropdownIcon]) }, { children: jsx(Icon, { icon: "arrowHeadDown" }) })));
    var selectElement = options && options && jsx(Select, __assign({ options: options }, props));
    var inputWrapper = (jsxs("div", __assign({ className: classes([style$7.inputWrapper, error && style$7.hasError]) }, { children: [icon1, selectElement || jsx(Element, __assign({}, props, (options ? { type: "text" } : {}))), iconSelect, icon2] })));
    return (jsxs("div", __assign({ className: containerClassName }, { children: [label ? (jsxs("label", { children: [jsx("span", __assign({ className: style$7.label }, { children: label })), inputWrapper] })) : (inputWrapper), error && jsx("div", __assign({ className: style$7.error }, { children: error })), children && jsx("div", __assign({ className: style$7.footer }, { children: children }))] })));
}
function Select(_a) {
    ...
    return (jsxs(Fragment$1, { children: [jsx("input", __assign({}, props, { value: selectedKey, className: style$7.select, readOnly: true })), jsx("div", __assign({ className: style$7.options }, { children: Object.keys(options).map(function (k) { return (jsx("button", __assign({ className: classes([style$7.option, options[k].value === props.value && style$7.selected]), type: "button" }, options[k], { onClick: onChangeOption }, { children: k }), k)); }) }))] }));
}

var css_248z$a = ".Loader-module_container__2cVGr {\n  height: 100%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}";
var style$6 = {"container":"Loader-module_container__2cVGr"};
styleInject(css_248z$a);

var css_248z$9 = ".Tableflow-module_tableflow__1Idr2 svg {\n  width: auto;\n}\n.Tableflow-module_tableflow__1Idr2.Tableflow-module_small__2B5rx svg {\n  height: 20px;\n}\n.Tableflow-module_tableflow__1Idr2.Tableflow-module_normal__2McCJ svg {\n  height: 26px;\n}\n.Tableflow-module_tableflow__1Idr2.Tableflow-module_big__9nhtU svg {\n  height: 32px;\n}";
var style$5 = {"tableflow":"Tableflow-module_tableflow__1Idr2","small":"Tableflow-module_small__2B5rx","normal":"Tableflow-module_normal__2McCJ","big":"Tableflow-module_big__9nhtU"};
styleInject(css_248z$9);

var css_248z$8 = ".Tableflow_tableflow__2PBf_ svg {\n  display: block;\n}\n.Tableflow_tableflow__2PBf_.Tableflow_lightBg__3oPEU svg path.Tableflow_letter__3vUVb {\n  fill: var(--color-tableflow-text) !important;\n}";
...
function Tableflow(_a) {
    ...
    var className = classes(["tableflow", style$5.tableflow, "lightBg" , style$5[size]]);
    return jsx("div", __assign({ className: className }, { children: color ? jsx(SvgTableflowLogoColor, {}) : jsx(SvgTableflowLogo, {}) }));
}

function Loader() {
    return (jsx("div", __assign({ className: style$6.container }, { children: jsx(Tableflow, { size: "big" }) })));
}
...
function Modal(_a) {
    ...
    var className = classes([style$4.container, isOpen ? style$4.isOpen : style$4.isClosing, props === null || props === void 0 ? void 0 : props.className]);
    ...
    var content = (jsx(FocusLock, { children: jsxs("div", __assign({}, props, { className: className }, { children: [jsx("div", { className: style$4.veil, onClick: function () { return handleClose && handleClose(); } }), jsxs(Element, __assign({ className: style$4.content }, { children: [useCloseButton && (jsx("button", __assign({ type: "button", onClick: handleClose, className: style$4.close }, { children: jsx(Icon, { icon: "cross" }) }))), children] }))] })) }));
...
var style$3 = {"paginator":"Pagination-module_paginator__3eAf-","arrow":"Pagination-module_arrow__1Va7h","selected":"Pagination-module_selected__KgulR"};
...
function Pagination(_a) {
    ...
    var renderPageNumbers = pages.map(function (number) {
        var className = classes([currentPage === number && style$3.selected]);
...
var style$2 = {"stepper":"Stepper-module_stepper__2dJhf","step":"Stepper-module_step__3QEhN","badge":"Stepper-module_badge__1_D6W","active":"Stepper-module_active__3CVhQ","done":"Stepper-module_done__15aUO"};
styleInject(css_248z$5);

function Stepper(_a) {
    var steps = _a.steps, current = _a.current, clickable = _a.clickable, setCurrent = _a.setCurrent;
    return (jsx("div", __assign({ className: style$2.stepper }, { children: steps.map(function (step, i) {
            var done = i < current;
            ...
            var buttonProps = clickable
                ...
                : {};
            return (jsxs(Element, __assign({ className: classes([style$2.step, i === current ? style$2.active : done && style$2.done]) }, buttonProps, { children: [jsx("div", __assign({ className: style$2.badge }, { children: done ? jsx(Icon, { icon: "check" }) : i + 1 })), jsx("div", __assign({ className: style$2.label }, { children: step.label }))] }), i));
        }) })));
}
...
var style$1 = {"tabs":"Tabs-module_tabs__eZFNO","tabBtn":"Tabs-module_tabBtn__TCjlj","active":"Tabs-module_active__2-7ln"};
styleInject(css_248z$2);

function Tabs(_a) {
    var tabs = _a.tabs, tab = _a.tab, setTab = _a.setTab, onChange = _a.onChange, children = _a.children;
    return (jsxs(Fragment$1, { children: [jsx("div", __assign({ className: style$1.tabs }, { children: Object.keys(tabs).map(function (k) { return (jsx("button", __assign({ type: "button", className: classes([style$1.tabBtn, tabs[k] === tab && style$1.active]), onClick: function () {
                        if (setTab)
                            setTab(tabs[k]);
                        if (onChange)
                            onChange(tabs[k]);
                    }, disabled: tabs[k] === tab }, { children: k }), k)); }) })), children && jsx("div", __assign({ className: classes([style$1.tabContent, style$1.active]) }, { children: children }))] }));
}
...
var style = {"container":"TagEditor-module_container__2eKme","backDrop":"TagEditor-module_backDrop__3W9Nk","tag":"TagEditor-module_tag__TH-1Z","input":"TagEditor-module_input__2aUcN","hasError":"TagEditor-module_hasError__1f5r2","error":"TagEditor-module_error__3OTzT","spacer":"TagEditor-module_spacer__1heGE"};
...
function Tag(_a) {
    ...
    return (jsxs("div", __assign({ className: classes([style.tag, error && style.hasError]), tabIndex: 0, title: error, onFocus: setIsSelected, ref: ref }, { children: [selected ? (jsx("span", __assign({ contentEditable: true, autoFocus: true, onInput: onChange, className: style.input, suppressContentEditableWarning: true }, { children: memoText }))) : (memoText), error && jsx(Icon, { icon: "error" }), jsx("button", __assign({ type: "button", onClick: function () { return removeTag(id); } }, { children: jsx(Icon, { icon: "cross" }) }))] })));
}
...
function TagEditor(_a) {
    ...
    return (jsxs(Fragment$1, { children: [jsxs("div", __assign({ className: classes([style.container, className]) }, props, { children: [jsx("div", { className: style.backDrop, onClick: function () { var _a; return (_a = ref === null || ref === void 0 ? void 0 : ref.current) === null || _a === void 0 ? void 0 : _a.focus(); } }), tags === null || tags === void 0 ? void 0 : tags.map(function (text, i) { return (jsx(Tag, __assign({}, { text: text, removeTag: removeTag, editTag: editTag, validation: validation, id: i }), text + i)); }), jsx("input", { placeholder: placeholder, onChange: onInputChange, value: input, ref: ref, onFocus: function (event) { return event.target.select(); }, onKeyDownCapture: handleKeyPress })] })), error && (jsxs("div", __assign({ className: style.error }, { children: [jsx(Icon, { icon: "error" }), " ", error] }))), jsx("div", { className: style.spacer })] }));
}

var css_248z = ".ThemeToggle_theme-toggle__nXOnk {\n  background-color: var(--color-border);\n  border-radius: 2rem;\n  border: 1px solid transparent;\n  padding: 4px;\n  transition: var(--transition-ui);\n  display: inline-block;\n  cursor: pointer;\n}\n.ThemeToggle_theme-toggle-inner__1TPYP {\n  display: flex;\n  isolation: isolate;\n  position: relative;\n}\n.ThemeToggle_theme-toggle-inner__1TPYP:after {\n  content: \"\";\n  position: absolute;\n  z-index: -1;\n  height: 100%;\n  width: 50%;\n  border-radius: var(--border-radius-r);\n  background-color: var(--color-green-ui);\n  left: 0;\n  transition: var(--transition-ui);\n  transform: translate(100%, 0);\n}\n.ThemeToggle_theme-toggle-inner__1TPYP > span {\n  padding: 6px;\n}\n.ThemeToggle_theme-toggle-inner__1TPYP > span > svg {\n  display: block;\n  width: 18px;\n  height: 18px;\n  object-position: center;\n}\n.ThemeToggle_theme-toggle-inner__1TPYP > span > svg path {\n  stroke: var(--color-icon);\n  transition: var(--transition-ui);\n}\nbody.ThemeToggle_light__1CnOH .ThemeToggle_theme-toggle__nXOnk {\n  background-color: transparent;\n  border-color: var(--color-border-soft);\n}\nbody.ThemeToggle_light__1CnOH .ThemeToggle_theme-toggle-inner__1TPYP:after {\n  transform: translate(0, 0);\n}\nbody.ThemeToggle_light__1CnOH .ThemeToggle_theme-toggle-inner__1TPYP > span:nth-child(1) > svg path {\n  stroke: var(--color-background-modal);\n}";
styleInject(css_248z);

function ThemeToggle() {
    //const setTheme = useThemeStore((state) => state.setTheme);
    var setTheme = function () { };
    return (jsx("button", __assign({ className: "theme-toggle", onClick: function () { return setTheme(); } }, { children: jsxs("span", __assign({ className: "theme-toggle-inner" }, { children: [jsx("span", { children: jsx(Icon, { icon: "sun" }) }), jsx("span", { children: jsx(Icon, { icon: "moon" }) })] })) })));
}

export { Badge, Box, Button, Dialog, Errors, Icon, Input, Loader, Modal, Pagination, Portal, Stepper, Switch, Table, Tableflow, Tabs, TagEditor, ThemeToggle };
//# sourceMappingURL=index.csj.js.map
